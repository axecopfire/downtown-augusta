...
async function main() {
  ...
  const events = await prisma.event.createMany({
    data: [
      ...
      // --- Book Tavern events (from booktavern.com/upcoming-events) ---
      {
        title: "Graphic Novel Book Club",
        description:
          "Every third Thursday of the month, discuss a graphic novel together in person at the shop. No themes, few rules, just good ol' fashion discussion. BYOB or enjoy a delicious beverage from the café.",
        address: "978 Broad St, Augusta, GA 30901",
        latitude: 33.4733,
        longitude: -81.9710,
        category: "community",
        ...
        endTime: "8:00 PM",
        impactLevel: "low",
        website: "https://booktavern.com/upcoming-events",
        businessId: bookTavern.id,
      },
      {
        title: "Book Character Day & Tea Tasting",
        description:
          "Don your best book character-inspired attire and join The Book Tavern for a special tea tasting experience. A fun literary costume event for all ages.",
        address: "978 Broad St, Augusta, GA 30901",
        latitude: 33.4733,
        longitude: -81.9710,
        category: "community",
      ...
      {
        title: "Book Club: Tinker Tailor Soldier Spy",
        description:
          "Monthly fiction book club discussing John le Carré's classic spy novel. The man he knew as 'Control' is dead, and George Smiley is drawn back into the Circus for one last mission.",
        address: "978 Broad St, Augusta, GA 30901",
        latitude: 33.4733,
        longitude: -81.9710,
        category: "community",
      ...
      {
        title: "Author Event: Cathy Goldberg Fishman – A Walk in the Forest",
        description:
          "Celebrate Cathy Goldberg Fishman's new release, A Walk in the Forest. Author of the award-winning children's series A Walk in the City, Cathy takes the numbers to the forest in this new picture book.",
        address: "978 Broad St, Augusta, GA 30901",
        latitude: 33.4733,
        longitude: -81.9710,
        category: "community",
      ...
      {
        title: "Pop-Up Signing: Carolyn Hooker",
        description:
          "Afternoon pop-up book signing with author Carolyn Hooker. Before the headlines, before the truth cracked through the silence — there was Carrie Butler. A powerful story of resilience.",
        address: "978 Broad St, Augusta, GA 30901",
        latitude: 33.4733,
        longitude: -81.9710,
        category: "community",
